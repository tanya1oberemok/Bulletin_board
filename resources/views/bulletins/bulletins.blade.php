        ...
        <div class="justify-content-center d-flex">
            <div class="col-12">
                <div class="card-header">
                    <a href="{{ url('create-bulletin') }}" class="btn btn-outline-info">Add bulletin</a>
                </div>
                                ...
                                <div class="card mr-4 mb-5" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-row">
                                            <a href="{{ url('show-bulletin', $bulletin->id) }}" class="btn btn-outline-success mr-5">Edit</a>
                                            <form action="{{ route('delete-bulletin', $bulletin->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
